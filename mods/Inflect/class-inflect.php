...
/*
 Module Name:	Inflect
Type:			Mod
Description:	Adds String inflect support to Ultimate CMS plugin
Author:			deepak.seth
...
class xydac_mods_inflect
{
	...
	public static function pluralize( $string )
	{
		...
		foreach ( self::$irregular as $pattern => $result )
		{
			...
			if ( preg_match( $pattern, $string ) )
				return self::titleize(preg_replace( $pattern, $result, $string));
		}
	...
	{
		return ucfirst(str_replace('_',' ',preg_replace('/_id$/', '',$string)));
	}
}
?>