<?php
if (!defined('XYDAC_CMS_EXPORT_PATH')) {
    define('XYDAC_CMS_EXPORT_PATH', get_bloginfo('wpurl') . "/wp-content/plugins/" . XYDAC_CMS_NAME . "/export.php");
}

if (!defined('XYDAC_CMS_EXPORT_CACHE')) {
    define('XYDAC_CMS_EXPORT_CACHE', "xydac_cms_export_cache");
}
