...
if (!defined('XYDAC_CMS_USER_API_KEY')) {
    define('XYDAC_CMS_USER_API_KEY', "xydac_cms_api_key");
}

if (!defined('XYDAC_CMS_OPTIONS')) {
    define('XYDAC_CMS_OPTIONS', "XYDAC_CMS_OPTIONS");
}

if (!defined('XYDAC_CMS_MODULES')) {
    define('XYDAC_CMS_MODULES', "xydac_cms_modules");
}

if (!defined('XYDAC_CMS_MODULES_BACKUP')) {
    define('XYDAC_CMS_MODULES_BACKUP', "xydac_cms_modules_backup");
}

if (!defined('XYDAC_CMS_MODULES_OLD_HASH')) {
    define('XYDAC_CMS_MODULES_OLD_HASH', "xydac_cms_modules_old_hash");
}

if (!defined('XYDAC_UCMS_FORMOPTION')) {
    define('XYDAC_UCMS_FORMOPTION', "XYDAC_UCMS_FORMOPTION");
}
...
class xydac_ultimate_cms
{
            ...
            if (is_dir($modules_root)) {
                ...
                if ($modules_dir) {
                    ...
                    foreach ($module_files as $file) {
                        if (!is_readable($modules_root . '/' . $file)) {
                            continue;
                        }
    ...
    /*------------------------------------------MODULES SECTION-----------------------------*/
    //@todo: handle ajax
    public function xydac_ajax_handler()
    {
        add_action("xydac_ajax_handler");
        die;
    }
    //-----------------------------------------------------Old Methods below
    public function xydac_cms_init()
    {
     ...
     * @Since 2.0
     */
    public function xydac_plugin_add_settings_link($links)
    {
        array_push($links,
    ...
    public function xydac_cms_site_head()
    {
    ...
    public function xydac_cms_admin_head()
    {
    ...
    public function xydac_cms_admin_foot()
    {
        self::xydac_cms_display_logs();
    }

    public function xydac_cms_main1()
    {
        new xydac_ultimate_cms_home();
    }
    public function xydac_cms_admin_menu()
    {
    ...
    public function xydac_cms_build_active_field_types()
    {
        $active = array();
    ...
    public function wp_info_notice()
    {
...
delete_transient(XYDAC_CMS_NAME . '_activated');
    ...
    public function xydac_activate_all_modules()
    {
        set_transient(XYDAC_CMS_NAME . '_activated', true, 10);
    }

    public function xydac_taxonomy_activate()
    {
        global $wpdb;
    ...
    public function is_xydac_ucms_pro()
    {
        //return false;
    ...
    public function xydac_cms_display_logs($type = 'WARNING')
    {
        if (false) {
            echo <<<DEBUG
		<style>
