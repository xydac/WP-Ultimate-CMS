...
class xydac_post_type_manager extends xydac_ultimate_cms_core
{
    ...
    public function __construct()
    {
        ...
        $form_variables = array(
            ...
            'view_items' => array('arr_label' => __('View Items Label of Post Type', XYDAC_CMS_NAME), 'name' => '[args][labels][view_items]', 'type' => 'string', 'desc' => __('the view item     text. Default is View Posts/View Pages', XYDAC_CMS_NAME), 'default' => ' '),
            ...
            'subheading-3' => array('arr_label' => __('Features', XYDAC_CMS_NAME), 'name' => 'xydac_acc_features', 'type' => 'subheading', 'initialclose' => true),
            ...
            'subheading-41' => array('arr_label' => __('Rewrite Options', XYDAC_CMS_NAME), 'name' => 'xydac_acc_rw_options', 'type' => 'subheading', 'initialclose' => true),
    ...
    public function xydac_core_rightfoot()
    ...
    public function xydac_core_head($data)
    {
    ...
    public function xydac_core_delete($name)
    {
    ...
    public function xydac_core_rowactions()
    {
        $action = array('Export' => XYDAC_CMS_EXPORT_PATH . "?cpt_name=");
        return $action;
    }
    public function xydac_core_doactions()
    {
    ...
    public function xydac_core_bulkaction($post)
    {
        switch ($_POST['action']) {
            case "export":{
                    $cpt = "";
    ...
    public function xydac_core_insert_update()
    {
    ...
    public function xydac_core_insert($datas)
    {
        $datas = array(0 => $datas);
        foreach ($datas as $k => $data) {
            ...
            $datas[$k]['args']['labels']['view_items'] = !empty($datas[$k]['args']['labels']['view_items']) ? $datas[$k]['args']['labels']['view_items'] : 'View ' . $datas[$k]['args']['label'];
