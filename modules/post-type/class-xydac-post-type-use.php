...
class xydac_post_type_use
{
    ...
    public function xydac_cms_ajax()
    {
    ...
    public function xydac_cpt_shortcode($atts, $text)
    {
        global $post;
        $text = trim($text);
    ...
    /* BEGIN META BOX CODE */
    public function custom_meta_admin()
    {
        //add_thickbox();
    ...
    public function custom_meta($post)
    {
...
// -- end shortcodes
    ...
    public function getShortcodeContents()
    {

        return $e;
    }

    public function custom_meta_save($post_id)
    {
