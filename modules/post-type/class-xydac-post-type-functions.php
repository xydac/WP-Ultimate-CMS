...
class xydac_post_type_functions
{
    ...
    public function xydac_cms_get_post($atts)
    {
        global $post;
        return $post->post_title;
    }
    public function the_content_manager($content)
    {
    ...
    public function xydac_enter_title_here_manager($content)
    {
        global $post;
    ...
    public function xydac_posts_home($query)
    {
    ...
    public function xydac_right_now()
    {
        $cpts = xydac()->modules->post_type->get_active(); //xydac_get_active_cpt();
