...
class xydac_taxonomy_type_manager extends xydac_ultimate_cms_core{
	...
	function __construct()
	{
		...
		parent::__construct("xydac_taxonomy",xydac()->modules->taxonomy_type->get_module_label(),xydac()->modules->taxonomy_type->get_base_path(),xydac()->modules->taxonomy_type->get_registered_option('main'),$form_variables,true,false);
