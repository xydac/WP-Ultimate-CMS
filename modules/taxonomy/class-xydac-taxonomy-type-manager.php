...
class xydac_taxonomy_type_manager extends xydac_ultimate_cms_core
{
    ...
    public function __construct()
    {
        ...
        $form_variables = array(
            ...
            'heading-3' => array('arr_label' => __('Rewrite Options', XYDAC_CMS_NAME), 'name' => 'xydac_acc_options', 'type' => 'subheading', 'initialclose' => true),
            ...
            'heading-4' => array('arr_label' => __('Permission and Capabilities', XYDAC_CMS_NAME), 'name' => 'xydac_acc_options', 'type' => 'subheading', 'initialclose' => true),
    ...
    public function xydac_core_bulkaction($taxonomy)
    {
        switch ($_POST['action']) {
            case "export":{
                    $cpt = "";
