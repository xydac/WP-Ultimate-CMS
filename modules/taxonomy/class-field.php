...
{
        public $ct_type;
        public $ct_field_name;
        public $ct_field_label;
        public $ct_field_type;
        public $ct_field_desc;
        public $ct_field_val;
        public $field;
        public function ct_fields($taxonomy, $name = null, $label = null, $type = null, $desc = null, $val = null)
    {
        ...
        public function taxonomy_columns($columns)
    {
        ...
        public function taxonomy_columns_manage($out, $column_name, $term)
    {
            global $wp_version;
    ...
    public function xydac_shortcode($atts, $text)
    {
        ...
        } else if ($showall == 'true') {$terms = get_terms($this->ct_type, 'hide_empty=0');} else {
            global $post;
