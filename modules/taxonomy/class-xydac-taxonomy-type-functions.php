...
class xydac_taxonomy_functions
{
     ...
     */
    public function xydac_taxonomy_define()
    {
    ...
    public function xydac_taxonomy_widgets_init()
    {
    ...
    public function xydac_meta_boxes()
    {
    ...
    public function xydac_meta_handler($post, $tax)
    {
...
<?php
    ...
    public function xydac_save_tax($post_id)
    {
    ...
    public function xydac_taxonomy_cols($columns, $post_type)
    {
        $taxonomies = xydac()->modules->taxonomy_type->get_active(); //xydac_get_active_taxonomy();
        if (is_array($taxonomies) && !empty($taxonomies)) {
            foreach ($taxonomies as $taxonomy) {
    ...
    public function xydac_taxonomy_custom_cols($column_name, $post_id)
    {
        $taxonomies = xydac()->modules->taxonomy_type->get_active(); //xydac_get_active_taxonomy();
        if (is_array($taxonomies) && !empty($taxonomies)) {
            foreach ($taxonomies as $taxonomy) {
    ...
    public function xydac_restrict_manage_posts()
    {
        global $typenow;
        $taxonomies = xydac()->modules->taxonomy_type->get_active(); //xydac_get_active_taxonomy();
        if (is_array($taxonomies) && !empty($taxonomies)) {
    ...
    public function xydac_print_html($taxonomy_name)
    {
    ...
    public function xydac_posts_where($where)
    {
        if (is_admin()) {
            global $wpdb;
            $taxonomies = xydac()->modules->taxonomy_type->get_active(); //xydac_get_active_taxonomy();
