...
class xydac_archive_type_manager extends xydac_ultimate_cms_core{
	...
	function __construct()
	{
		...
		parent::__construct("xydac_archive_type",xydac()->modules->archive_type->get_module_label(),xydac()->modules->archive_type->get_base_path(),xydac()->modules->archive_type->get_registered_option('main'),$form_variables);
	}
