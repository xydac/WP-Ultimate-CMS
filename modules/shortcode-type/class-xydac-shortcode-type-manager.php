...
class xydac_shortcode_type_manager extends xydac_ultimate_cms_core{
	...
	function __construct()
	{
		$form_variables = array(
				...
				'attr' => array( 'arr_label' => __('Attributes',XYDAC_CMS_NAME) , 'name' => '[attr]', 'type'=>'textarea', 'desc'=> __('Please Enter valid attributes one in a line. You can use these attributes in template below.',XYDAC_CMS_NAME) , 'default'=>' ', 'height'=>'100px'),
				'customhtml' => array( 'arr_label' => __('Template',XYDAC_CMS_NAME) , 'name' => '[customhtml]', 'type'=>'textarea', 'desc'=> __('The Custom template to be used for shortcodes ',XYDAC_CMS_NAME) , 'default'=>' ', 'height'=>'100px'),
		...
		$args = array('custom_css_id'=>'customcss','custom_jss_id'=>'customscript');//this doesn't work here put it in modules
