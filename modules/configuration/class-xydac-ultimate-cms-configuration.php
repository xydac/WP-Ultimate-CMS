...
class xydac_ultimate_cms_configuration extends xydac_cms_module
{
    public $tabs;
    public $base_path;
    public $configurationformfield = array();
    ...
    public function render_formelements($name, $label, $type, $description, $value, $options = array())
    {
        if ($type == 'text') {
    ...
    public function xydac_cms_module_view_main_func($tabname)
    {
