...
class xydac_snippets_customstuff extends xydac_snippets
{
    ...
    public function wps_get_comment_list_by_user($clauses)
    {
        if (is_admin()) {
            global $user_ID, $wpdb;
    ...
    public function wphub_firstattchasfeat($content)
    {
        global $post;
    ...
    public function wphub_featimginfeed($content)
    {
        global $post;
    ...
    public function wphub_excludepagefrmsearch($query)
    {
        if ($query->is_search) {
    ...
    public function wphub_redirectpostonsingleres()
    {
        if (is_search()) {
            global $wp_query;
    ...
    public function wphub_minimumcommentlimit($commentdata)
    {
